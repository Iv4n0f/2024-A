...
public:
    Product(double price, TaxStrategy* strategy) : price(price), taxStrategy(strategy) {}
...
int main() {
    ...
    std::cout << "Basic Product Total Price: " << basicProduct.calculateTotalPrice() << std::endl;
    std::cout << "Luxury Product Total Price: " << luxuryProduct.calculateTotalPrice() << std::endl;
    std::cout << "Exempt Product Total Price: " << exemptProduct.calculateTotalPrice() << std::endl;

    // Cambiar la estrategia de impuestos para un producto 
    exemptProduct.setTaxStrategy(&basicTax);
    std::cout << "Exempt Product Total Price (after strategy change): " << exemptProduct.calculateTotalPrice() << std::endl;
